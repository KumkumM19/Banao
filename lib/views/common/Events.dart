              ...
              itemBuilder: (BuildContext context, int index) {
                return Container(
                    ...
                    child:Column(
                      ...
                      children: [
                        Image(image: AssetImage(list2[index]),height: MediaQuery.of(context).size.height*0.1735,
                          width: MediaQuery.of(context).size.width,),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(list2c[index],style: TextStyle(fontSize: 12,fontFamily: interm,color: grey1),),
                              Container(
                                height:30,
                                child: OutlinedButton(onPressed: (){},
                                    ...
                                    child: Text("Book",style: TextStyle(fontFamily: intersb,fontSize: 12,color: blue1),)),
                              )
                            ],
                          ),
                        )
